...
book_link = browser.find_element(By.XPATH, value="/html/body/table[1]/tbody/tr[3]/td[4]/a")
book_link.click()
assert browser.current_url == "http://127.0.0.1:5000/book/New%20Games/Simply%20Lift"
